            ...
            <div class="card-body">
                <form action="{{ $action }}" method="{{ $method }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name" name="company_name" value="{{ old('company_name') ?? (isset($userData) ? $userData->name : '') }}">
                        @error('company_name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="company_email" class="form-control @error('company_email') is-invalid @enderror" id="company_email" aria-describedby="emailHelp" name="company_email" value="{{ old('company_email') ?? (isset($userData) ? $userData->email : '') }}">
                        @if(isset($userData))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('company_website') is-invalid @enderror" id="company_website" name="company_website" value="{{ old('company_website') ?? (isset($userData) ? $userData->name : '') }}">
